...
class BookController {
    ...
    private async updateBook(request: Request, response: Response, next: NextFunction): Promise<void> {
        try {
            const _id = request.params._id;
    ...
    private async deleteBook(request: Request, response: Response, next: NextFunction): Promise<void> {
        try {
            const _id = request.params._id;
    ...
    private async getSomeBooks(request: Request, response: Response, next: NextFunction): Promise<void> {
        try {
